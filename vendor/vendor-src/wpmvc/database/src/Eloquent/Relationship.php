...
namespace ProposalCrafter\WpMVC\Database\Eloquent;

\defined("ABSPATH") || exit;
use ProposalCrafter\WpMVC\Database\Eloquent\Relations\BelongsToMany;
use ProposalCrafter\WpMVC\Database\Eloquent\Relations\BelongsToOne;
use ProposalCrafter\WpMVC\Database\Eloquent\Relations\HasOne;
use ProposalCrafter\WpMVC\Database\Eloquent\Relations\Relation;
use ProposalCrafter\WpMVC\Database\Query\Builder;
use wpdb;
class Relationship
{
