...
namespace ProposalCrafter\WpMVC\Container;

\defined('ABSPATH') || exit;
use ReflectionClass;
use ReflectionNamedType;
use ProposalCrafter\Psr\Container\ContainerInterface;
use ProposalCrafter\WpMVC\Container\Exception\ContainerException;
use ProposalCrafter\WpMVC\Container\Exception\NotFoundException;
/**
