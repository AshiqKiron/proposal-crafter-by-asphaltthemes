...
namespace ProposalCrafter\WpMVC\Routing;

\defined('ABSPATH') || exit;
use ProposalCrafter\WpMVC\Routing\Providers\RouteServiceProvider;
use ProposalCrafter\WpMVC\Routing\Contracts\Middleware as MiddlewareContract;
use WP_Error;
class Middleware
{
