...
export const WhenResponsiveScreen = ( props ) => {
	...
	const isNoScreen =
		! props.screens.includes( deviceType.toLowerCase() ) &&
		! isCurrentScreen &&
		deviceType === 'Desktop';

	return (
		<Fragment>{ ( isCurrentScreen || isNoScreen ) && children }</Fragment>
	);
};
