...
export const SYSTEM_FONT_STACKS = {
	'Sans-Serif': {
		...
		label: __( 'Sans-Serif', 'asphalt-proposal-manager' ),
	},
	Serif: {
		...
		label: __( 'Serif', 'asphalt-proposal-manager' ),
	},
	'Serif-Alt': {
		...
		label: __( 'Serif Alternative', 'asphalt-proposal-manager' ),
	},
	Monospace: {
		value: 'SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace',
		label: __( 'Monospace', 'asphalt-proposal-manager' ),
	},
};
...
export const createLinkTagWithGoogleFont = ( fontName = '' ) => {
	...
	link.classList.add( 'pc-google-fonts' );
...
const getDocumentHead = () => {
	const hasEditingContent = !! document.querySelector(
